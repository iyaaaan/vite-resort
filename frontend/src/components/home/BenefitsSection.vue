<template>
  <section
    class="container flex flex-wrap items-start justify-center border-b border-b-gray-500 px-0 py-48 text-neutral-600"
  >
    ...
    <div class="mt-10 flex w-full flex-wrap p-4 lg:mt-0 lg:w-1/2">
      <h2
        class="mb-8 basis-full self-center font-Playfair text-5xl text-beaver"
      >
        The Perks
      </h2>
      ...
      <div class="w-full pr-4 pb-4 md:w-1/2">
        <h3
          class="after:7 relative font-semibold text-gray-700 after:absolute after:-bottom-1 after:left-0 after:h-1 after:w-7 after:bg-secondary after:content-['']"
        >
